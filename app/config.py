...
class Config:
    ...
    NOTEBOOKLM_STORAGE_PATH = _env("NOTEBOOKLM_STORAGE_PATH", "")
    NOTEBOOKLM_AUDIO_LANGUAGE = _env("NOTEBOOKLM_AUDIO_LANGUAGE", "zh-CN")
    NOTEBOOKLM_AUDIO_TIMEOUT_SECONDS = int(_env("NOTEBOOKLM_AUDIO_TIMEOUT_SECONDS", 900))
    NOTEBOOKLM_SOURCE_WAIT_TIMEOUT_SECONDS = int(_env("NOTEBOOKLM_SOURCE_WAIT_TIMEOUT_SECONDS", 240))
    NOTEBOOKLM_AUTO_DELETE_NOTEBOOK = _env("NOTEBOOKLM_AUTO_DELETE_NOTEBOOK", "1")
    NOTEBOOKLM_AUDIO_INSTRUCTIONS = _env("NOTEBOOKLM_AUDIO_INSTRUCTIONS", "")
