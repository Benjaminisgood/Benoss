...
SETTING_DEFINITIONS: list[dict] = [
    ...
    },
    {
        ...
        "label": "向量 Embedding 模型",
        "type": "string",
        "group": "站点",
        "description": "用于向量索引与检索查询的 embedding 模型。",
    ...
    },
    {
        ...
        "type": "choice",
        "group": "AI 基础",
        "description": "全局 AI 默认 provider（聊天/向量/TTS/图片默认都先走这个）。",
        "default": "",
        "options": [
            {"label": "关闭", "value": ""},
    ...
    },
    {
        ...
        "type": "choice",
        "group": "AI 基础",
        "description": "播客音频生成使用的 provider（留空表示跟随 AI 主 Provider）。",
        "default": "",
        "options": [
            {"label": "跟随 AI 主 Provider", "value": ""},
            {"label": "openai", "value": "openai"},
            {"label": "chatanywhere", "value": "chatanywhere"},
            {"label": "deepseek", "value": "deepseek"},
            {"label": "aliyun", "value": "aliyun"},
    ...
    },
    {
        ...
        "type": "choice",
        "group": "AI 基础",
        "description": "海报图片生成使用的 provider（留空表示跟随 AI 主 Provider）。",
        "default": "",
        "options": [
            {"label": "跟随 AI 主 Provider", "value": ""},
            {"label": "openai", "value": "openai"},
    ...
    },
    {
        ...
        "type": "string",
        "group": "AI 基础",
        "description": "海报生成模型。留空则按 provider 默认模型自动选择。",
        "default": "",
    },
    {
        "key": "AI_TTS_MODEL",
        ...
        "type": "string",
        "group": "AI 基础",
        "description": "播客音频生成模型。留空则按 provider 默认模型自动选择。",
        "default": "",
    },
    {
        "key": "AI_TTS_VOICE",
